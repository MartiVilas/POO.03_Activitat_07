 ...
 */
fun llegirWord(pMessageIn: String
 ...
 * @return outputValue Output value
 */
fun llegirSentence(pMessageIn: String
                 , pMessageErrorDT: String
): String{
 ...
 * @return outputValue Output value
 */
fun llegirChar(pMessageIn: String
             , pMessageErrorDT: String
): Char{
 ...
 * @return outputValue Output value
 */
fun lleigrChar(pMessageIn: String
             , pMessageErrorDT: String
             , pCase: Int
): Char{
 ...
 * @return outputValue Output value
 */
fun llegirBoolean(pMessageIn: String
                , pMessageErrorDT: String
): Boolean{
 ...
 * @return outputValue Output value
 */
fun llegirInt(pMessageIn: String, pMessageErrorDT: String, pMessageErrorDV:String, pMin: Int): Int {
    var outputValue: Int = 0
    var correctDataType: Boolean = false
 ...
 * @return outputValue Output value
 */
fun llegirFloat(pMessageIn: String
              , pMessageErrorDT: String
): Float{
 ...
 */
fun arrodonirFloat(num: Number, decimals: Int): Float {
...
/**
 * Funcio que es por utilitzar per a llegir si el usuari diu que SI o que NO
 * @author Marti Vilas
 * @return retorna true o false depenents de el que tu vulguis si vols que si sigui false es pot canviar.
 */
